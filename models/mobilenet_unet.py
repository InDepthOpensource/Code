...
from models import BasicDecoderBlock, LastUnetDecoderBlock
...
class MobileNetUNet(nn.Module):
    def __init__(self, device, num_res_block_decoder=2,
                 decoder_input_lengths=((0, 160, 160), (64, 64, 64), (32, 32, 32), (24, 24, 24), (32, 32, 32)),
                 decoder_dilation_rates=((1, 3), (1, 3, 6), (1, 3, 6), (1, 3, 6), (1, 3, 6)),
                 decoder_internal_channels=(64, 32, 24, 32, 16),
                 decoder_output_channels=(64, 32, 24, 32, 16)):

        super().__init__()

        self.device = device
        self.rgb_encoder = mobilenet_v2(pretrained=True)
        self.depth_encoder = MobileNetV2(input_channels=2)
    ...
    def forward(self, color_input, depth_input):
        ...
        rgb_representations = self.rgb_encoder(color_input)
        depth_representations = self.depth_encoder(depth_input)
...
if __name__ == '__main__':
    ...
    efficient_unet = MobileNetUNet(device)
