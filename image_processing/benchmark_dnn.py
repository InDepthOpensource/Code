...
if __name__ == '__main__':
    ...
    parser.add_argument('--load-model', type=str,
                        default='/Users/user/PycharmProjects/DepthCompletion/tmp/best_l1_originalcbam6crop_finetune.pth')
    parser.add_argument('--rgb-file-name', type=str, default='')
    parser.add_argument('--depth-file-name', type=str, default='')
    ...
    for _ in range(args.iterations):
        rgb_filename = args.rgb_file_name
        depth_filename = args.depth_file_name
        ...
        with torch.no_grad():
            ...
            start = time.time()
            cv2.imwrite('dummy_completed_z16.png', (pred[0][0] * 1000).astype(np.uint16))
            end = time.time()
